...
%      4.  Add atomic O from SABER
%      5.  APpend AFGL to 120 km
...
addpath /asl/matlib/time               % dtime2tai
...
% -------------------------------------------------------
%  load SAF704 pressure levels on 147 grid (plevs147)
% -------------------------------------------------------
load('/home/chepplew/myLib/data/SAF704_plevs.mat','plevs147');
...
% ---------------------------------------------------------------
% get SABER and afgl atomicO (gas.34)
% ---------------------------------------------------------------
