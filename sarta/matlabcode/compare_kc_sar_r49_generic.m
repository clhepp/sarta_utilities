...
switch csens
  ...
  case 'AIRS_L1C'
    ...
    SARTAEXE = '/home/chepplew/gitLib/sarta/bin/airs_l1c_jul2022'; % or v3
...
%    x       = load('/home/chepplew/myLib/data/cris_freq_2grd.mat');
  ...
  case 'CRIS_HR'
    ...
    SARTAEXE = '/home/chepplew/gitLib/sarta/bin/cris_hr_jul2022';

  case 'CHIRP'
% use chirp_1702_freq for nonguard channel coefficients, chirp_1702_freq_4grd otherwise.
% if 4grd channels & kcarta=1702, rn SARTA with grd.channel IDs appended at end.
%  idchan = [];
...
switch csens
  ...
  case {'AIRS_L1C','CRIS_LR','CRIS_HR','CHIRP'}
    ...
    calc.rsc = pds.rcalc;
    calc.bsc = rad2bt(sfreq, pds.rcalc(iss,:));

  otherwise
    disp('unable to resolve sensor option to execute')
